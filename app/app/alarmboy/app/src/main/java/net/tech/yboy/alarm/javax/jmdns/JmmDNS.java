 ...
 *
 */
package net.tech.yboy.alarm.javax.jmdns;
...
import net.tech.yboy.alarm.javax.jmdns.impl.JmmDNSImpl;

/**
 * <p>
 * Java Multihomed Multicast DNS
 * </p>
 * Uses an underlying {@link JmDNS} instance for each {@link java.net.InetAddress} found on this computer.<br/>
...
public interface JmmDNS extends Closeable {
    ...
    public static final class Factory {
        ...
        public static interface ClassDelegate {
             ...
             * @see #classDelegate()
             * @see #setClassDelegate(net.tech.yboy.alarm.javax.jmdns.JmmDNS.Factory.ClassDelegate anObject)
             */
         ...
         * @see #classDelegate()
         * @see net.tech.yboy.alarm.javax.jmdns.JmmDNS.Factory.ClassDelegate
         */
     ...
     * @see javax.jmdns.JmDNS#getServiceInfo(String, String)
     */
     ...
     * @return list of service info. If no service info is found the list is empty.
     * @see javax.jmdns.JmDNS#getServiceInfo(String, String, long)
     */
     ...
     * @return list of service info. If no service info is found the list is empty.
     * @see javax.jmdns.JmDNS#getServiceInfo(String, String, boolean)
     */
     ...
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new new information is received.
     * @return list of service info. If no service info is found the list is empty.
     * @see javax.jmdns.JmDNS#getServiceInfo(String, String, boolean, long)
     */
     ...
     * @param name
     *            unqualified service name, such as <code>foobar</code> .
     * @see javax.jmdns.JmDNS#requestServiceInfo(String, String)
     */
     ...
     * @param persistent
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new new information is received.
     * @see javax.jmdns.JmDNS#requestServiceInfo(String, String, boolean)
     */
     ...
     * @see javax.jmdns.JmDNS#requestServiceInfo(String, String, long)
     */
     ...
     * @param timeout
     *            timeout in milliseconds
     * @see javax.jmdns.JmDNS#requestServiceInfo(String, String, boolean, long)
     */
     ...
     * @see javax.jmdns.JmDNS#addServiceListener(String, javax.jmdns.ServiceListener)
     */
     ...
     * @param listener
     *            listener for service updates
     * @see javax.jmdns.JmDNS#removeServiceListener(String, javax.jmdns.ServiceListener)
     */
     ...
     * @param type
     *            full qualified service type, such as <code>_http._tcp.local.</code>.
     * @see javax.jmdns.JmDNS#registerServiceType(String)
     */
     ...
     * @see javax.jmdns.JmDNS#list(String)
     */
     ...
     * @return An array of service instance.
     * @see javax.jmdns.JmDNS#list(String, long)
     */
     ...
     * @see javax.jmdns.JmDNS#listBySubtype(String)
     */
     ...
     *            timeout in milliseconds. Typical timeout should be 6s.
     * @return A dictionary of service info by subtypes.
     * @see javax.jmdns.JmDNS#listBySubtype(String, long)
     */
