...
import net.tech.yboy.alarm.javax.jmdns.impl.NetworkTopologyDiscoveryImpl;
...
public interface NetworkTopologyDiscovery {
    ...
    public static final class Factory {
        ...
        public static interface ClassDelegate {
             ...
             * @see #classDelegate()
             * @see #setClassDelegate(net.tech.yboy.alarm.javax.jmdns.NetworkTopologyDiscovery.Factory.ClassDelegate anObject)
             */
            public NetworkTopologyDiscovery newNetworkTopologyDiscovery();
        }
